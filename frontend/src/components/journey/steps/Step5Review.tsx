...
function adjusterFocus(markdown: string): string[] {
  ...
  return focus.length > 0
    ? focus.slice(0, 4)
    : [
        "Review key fields, inconsistencies, and missing evidence before requesting the decision.",
      ];
}
        ...
        <div className={styles.grid}>
          <div className={styles.column}>
            ...
            >
              ...
              <Caption1 style={{ color: tokens.colorNeutralForeground3 }}>Editable</Caption1>
            </div>
            <Textarea
              value={markdown}
          ...
          <div className={styles.column}>
            ...
            {Object.keys(facts).length > 0 ? (
              ...
              <div className={styles.focusList}>
                {adjusterFocus(markdown).map((item) => (
                  <Body1 key={item} className={styles.focusItem}>
                    {item}
                  </Body1>
                ))}
              </div>
            ...
            >
              <Checkbox
                ...
                label={
                  <Body1>
                    I&apos;ve reviewed the drafted summary against the source documents and confirm
