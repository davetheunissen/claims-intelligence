...
const useStyles = makeStyles({
  ...
  mapPlaceholder: {
    ...
    backgroundImage: "linear-gradient(135deg, rgba(43,197,180,0.10), rgba(35,105,186,0.10))",
...
function shortWatchOut(text: string): string {
  ...
  if (lower.includes("estimate") || lower.includes("repair") || lower.includes("$"))
                  ...
                  {data.watchOuts.map((w, i) => {
                    ...
                    return (
                      <div key={i} className={styles.watchItem}>
                        <Warning20Filled
                          style={{
                            color: conflict ? tokens.colorPaletteRedForeground1 : "#FFCF03",
                          }}
                        />
                        <Body1
                          style={
              ...
              {data.timeline.map((entry, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <Body1 className={styles.timelineLabel}>
                        {s(entry.label) || s(entry.detail)}
                      </Body1>
            ...
            <div className={styles.column}>
              ...
              {data.vehicles.map((v, idx) => {
                ...
                const detail =
                  [
                    s(v.vin) && `VIN ${s(v.vin)}`,
                    s(v.registration) && `Reg ${s(v.registration)}`,
                  ]
                    .filter(Boolean)
                    .join(" · ") || s(v.detail);
                return (
